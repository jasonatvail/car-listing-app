#!/bin/bash
# deploy-ecs-prod.sh - Deploy ECS infrastructure for production environment with proper networking

set -e

STACK_NAME="car-listing-prod"
REGION="us-east-2"
...
# ECR Image URIs (use latest tags for production environment)
BACKEND_IMAGE="public.ecr.aws/c9g5y1u8/carswebapppublic:backend-latest"
FRONTEND_IMAGE="public.ecr.aws/c9g5y1u8/carswebapppublic:frontend-latest"

echo ""
echo "🚀 Deploying ECS Infrastructure for Production Environment"
echo "=========================================================="
echo ""
...
echo "4. Push a production tag (vX.Y.Z) to GitHub to trigger deployments"
echo ""
echo "🔐 Security Note:"
